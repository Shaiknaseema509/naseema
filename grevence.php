...
var xmlHttp=newHttpObject();
	...
	if(spocname == "")	
	  ...
	  var callQuery="type=SaveBeneficiary&agent_id=<?=$agentID;?>&contact_no=<?=$phone_number;?>&spoccontact="+spoccontact+"&sEmail="+sEmail+"&Facility="+Facility+"&spocname="+spocname+"&city_name1="+city_name1+"&tehsil1="+tehsil1+"&rdate="+rdate+"&District="+District+"&call_id="+2012121+"&noc="+noc+"&Designation="+Designation+"&complaintagainst="+complaintagainst+"&goc="+goc+"&Compliant="+Compliant+"&facility_name="+facility_name;
		//alert(callQuery);
...
<div class="col-md-12" style="color:white; padding:5px;background: radial-gradient(ellipse farthest-corner at center center, rgba(0,0,0,0.5) 20%, rgba(0,0,0,0.85) 100%) repeat scroll 0% 0%; "> 
	...
	<table 	class="tble tale-stiped ac" cellspacing="5" cellpadding="5">
		...
		<tr>
		<td> SPOC Email</td>
			<td><input type="text" id="sEmail" class="form-control" style="width:160px" />  </td>
			<td> <label style="float:left"><input type="checkbox" value="SMS" /> SMS </label><input type="checkbox" value="EMAIL" /> EMAIL </label></td>
