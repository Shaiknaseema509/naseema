...
$followup_numb = mysql_query("delete from `followup_save_details` where callid = '".$call_id."' and followup_number = 1 and ambulance_reached_on_time is null");
$followup_numb = mysql_query("delete from `followup_save_details` where callid = '".$call_id."' and followup_number in(2,3,4,5,6,7,8,9) and how_are_you_feeling_now is null");

$followup_numb = mysql_query("select followup_number from `followup_save_details` where callid = '".$call_id."' order by followup_number desc");
