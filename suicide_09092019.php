		...
		if(xmlHttp)
		 {
			...
			var callQuery="type=SaveDetails&agent_id=<?=$agentID;?>&phone_number="+phone_number+"&ano="+ano+"&age_type="+monthyear+"&call_id="+call_id+"&age="+age+"&Gender="+gender+"&district_id="+district_id+"&block_id="+block_id+"&village_id="+village_id+"&address="+address+"&caller_name="+caller_name+"&patient_name="+patient_name;
                                            ...
                                            <div class="row">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" id="caller_name" onkeypress="return allowValidKey(event,'callername');" onkeyup="return removeSP('beneficiary_lname');"  placeholder="Type Last Name..." class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
												 ...
												 <div class="span6"  >
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" id="patient_name" onkeypress="return allowValidKey(event,'callername');"  onkeyup="return removeSP('beneficiary_lname');"
					...
					$SEL = ($Beneficiary_Details['village_id'])?"selected":"";
 					echo  ($district_details['ct_ctid'])?"<option  value='".$district_details['ct_ctid']."~".$district_details['ct_lname']."' $SEL>".$district_details['ct_lname']."</option>":"<option value=''>--Pickup City--</option>";
                                            ...
                                            <div class="row">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" id='address' class="form-control" name='address' value="<?php echo $Beneficiary_Details['address'];?>"  placeholder="Enter Landmark..." class="span12">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="control-group" style="float:right">
                                                <div class="controls">
                                                    <input type="button" onclick="return saveBeneficiaryDetails1();" class="btn btn-large btn-primary" value="Registration" />
                                                </div>
