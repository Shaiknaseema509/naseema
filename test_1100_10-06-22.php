...
if($phone_number == '') $phone_number='73864001325';
...
<div class="alert">
    ...
    <!-- /navbar -->
    <div class="wrapper custm_wrapper" style="min-height:600px;">
        <div class="row custm_row_pdng" style="">
            <div class="container-fluid" style=""><input type="hidden" value="<?=$phone_number;?>" id="phone_number_val" />
              
			 <div class="">
                    <div class="content">
                        <section id="section_one" style="min-height: 270px;">
                            <div class="btn-controls" style="color:#000;background: radial-gradient(ellipse farthest-corner at center center) repeat scroll 0% 0%; min-height:270px;max-height:410px;overflow-x: hidden;overflow-y:scroll;background-color: #e1dfdf;border: 1px solid #eedcdc;">
                                            ...
                                            <div class="row custm_row">
                                             ...
                                             <!--   <div class="span6" style="display:none">
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
													    <div class="custm_label">
                                                            <label class="custm_label_text" for="basicinput">Callid</label>
														</div>
                                                        <div class="custm_input">
                                                            <input class="form-control custm_form_input" type="text" id="callid" readonly value="<?php echo $callid;?>" placeholder="Type Phone Number..." class="span12">
		...
		<!--		<option value=''>Select Tehsil</option>-->
				...
				?>	
                                            ...
                                            <div class="row custm_row">
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
														...
														<p id="basicinputNumberbeneficiary_ids_label" style="padding-top:6px"> <?php echo $Beneficiary_Details['registration_id'];?></p>
													   </div>
                                                    </div>
                                                </div>
                                            </div>
						 ...
						 <section id="section_one" style="min-height: 370px;">
                            <div class="btn-controls" style="color:#000;background: radial-gradient(ellipse farthest-corner at center center) repeat scroll 0% 0%; min-height:365px;max-height:365px;overflow-x: hidden;overflow-y:scroll;background-color: #e1dfdf;border: 1px solid #eedcdc;">
                                ...
                                <div class="modue">
									...
									<legend class="custm_legend">
									    ...
									    <div class="module-head custm_call_closer">
											<h3>Case Details - <?php echo $callid;?></h3>
										</div>
									</legend>
                                        <form class="form-horizontal row-fluid">
											...
											<div class="row custm_row"> 	
												<div class="custm_col_3">
                                                    ...
                                                    <div class="custm_width">
                                                        ...
                                                        <div class="custm_input">
                                                            <select class="form-control custm_form_select custm_form_input" style="font-family:arial;" id='call_type' name='call_type' class="form-control">
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
                                                        ...
                                                        <div class="custm_input">
                                                            <select name="mhu" id="mhu" class="form-control custm_form_select custm_form_input">
															<option value="">Select </option>
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
                                                        ...
                                                        <div class="custm_input">
                                                            <select name="sysdig" id="sysdig" class="form-control custm_form_select custm_form_input">
															<option value="">Select </option>
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
                                                        ...
                                                        <div class="custm_input">
                                                            <select name="doctor_type" id="doctor_type" onchange="return getdoctortype();" class="form-control custm_form_select custm_form_input">
															<option value="">Select </option>
											...
											<div class="row custm_row"> 	
												 <div class="custm_col_3">
                                                    <div class="custm_width">
                                                        ...
                                                        <div class="custm_input">
                                                            <select id="consr" class="form-control custm_form_select custm_form_input"><option value="YES">Yes</option><option selected value="NO">No</option></select>
														</div>
                                                    </div>
                                                </div>
												<div class="custm_col_3">
                                                    <div class="custm_width">
													    <div class="custm_label">
															...
															<div class="custm_input">
                                                            <select name="sysdoc" id="sysdoc" class="select_combo form-control custm_form_select custm_form_input" onchange="return getcontact();">
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
													    <div class="custm_label">
                                                            <label class="custm_label_text" for="basicinput">Doctor Number</label>
														</div>
														<div class="custm_input">
															<div><input type = "text" id="txtcontact" name="txtcontact" class="form-control custm_form_input" style="width: 134px;"/>
															   <input type="button" id="btncall" class="btn btn-success" name="abds" value="Call" onclick="return  conCall();" />
														    </div>
                                                        </div>
													</div>
												...
												<div class="custm_col_3">
                                                    <div class="custm_width">
                                                        ...
                                                        <div class="custm_input">
                                                            <select multiple name="lab_test" id="lab_test" class="form-control custm_form_select custm_form_input">
															<option value="">Select </option>
											...
											<div class="row custm_row"> 	
												<div class="custm_col_3">
                                                    <div class="custm_width">
													    <div class="custm_label">
                                                            <label class="custm_label_text" for="basicinput">	Advice by Specialist </label>
														</div>
                                                        <div class="custm_input d-f-advice">
											...
											<div class="row custm_row" id="drugFormUnit" style="display:none;" > 	
												<div class="span12">
                                                    <div class="control-group">
                                                        <table class="table custm_table_td" width="60%" style="width:60%;border:1px solid #888585!important;margin-left:14px ">
															<tr>
																<td>S.no</td>
																<td>Drug FORM</td>
																<td>Medicine</td>
											...
											<div class="row custm_row"> 	
												...
												<div class="span6" >
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input style=display:none; type="button" id="drug_Save" class="btn btn-success custm_btn_m_b" name="abds" value="Submit" onclick="return  drug_save();" />
														</div> 
                                                    </div>
                                                </div>                                          
											</div>
