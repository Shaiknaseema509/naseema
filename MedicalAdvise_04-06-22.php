	...
	<div class="row" style="background-color:">
		...
		<table cellpadding="3" cellspacing="3" class="table-responsive"  >
            ...
            <div style="padding-bottom:15px">
                ...
                <div class="custm_MHU">
				<select name="GroupId_MHU" id="GroupId_MHU" onchange="return showHidedrugs_mhu(this.value); ">
			...
			<table cellpadding="3" class="table" cellspacing="3" >
				...
				<tr>
					...
					<td colspan="2" align="right">
						...
						<input type="button" value="Submit" class="btn-success" onclick="Savedrugdetails();" />
					</td>
				</tr>	
