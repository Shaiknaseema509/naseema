        ...
        function saveGrievanceDetails()
         {
			...
			var call_id = "<?=$_REQUEST["call_id"];?>"; //alert(call_id);
			var beneficiary_id = "<?=$_REQUEST["beneficiary_id"];?>"; //alert(beneficiary_id);
			var aadhar_no = "<?=$_REQUEST["uid"];?>"; //alert(aadhar_no);
			var call_type = "<?=$_REQUEST["call_type"];?>";
                        var callQuery="type=SaveGrievance&agent_id=<?=$_REQUEST["agentid"];?>&contact_no=<?=$_REQUEST["phone_number"];?>&call_id="+call_id+"&beneficiary_id="+beneficiary_id+"&aadhar_no="+aadhar_no+"&source="+source+"&date="+date+"&grievance_type="+grievance_type+"&nature="+nature+"&name="+name+"&mobile1="+mobile1+"&mobile2="+mobile2+"&email="+email+"&area="+area+"&state="+state+"&district_id="+district_id+"&block_id="+block_id+"&village_id="+village_id+"&branch="+branch+"&residential_address="+residential_address+"&brief_application="+brief_application+"&call_type="+call_type;
