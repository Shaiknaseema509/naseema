...
switch($action)
{
   case 'SaveBeneficiary':
		...
		complaintagainst='".$complaintagainst."', Designation='".$Designation."',  facility_type_id='".$Facility[0]."',facility_id='".$facility_name[0]."',
		nComplaint='".$noc."', gistComplatint='".mysql_escape_string($goc)."', rdate='".$rdate."',   district_id='".$district_id[0]."', 
...
/*
	...
	case 'updategreven':   
		...
		{			 
			$Query123	= "update grievance SET complaintId='".$Compliant."',contact_no='".$contact_no."',agent_id='".$agent_id."',
		complaintagainst='".$complaintagainst."', Designation='".$Designation."',  facility_type_id='".$Facility[0]."',facility_id='".$facility_name[0]."',
		nComplaint='".$noc."', gistComplatint='".$goc."', rdate='".$rdate."',   district_id='".$district_id[0]."', 
		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."', 
		village_name='".$village_id[1]."' where call_id='".$call_id."'";	
