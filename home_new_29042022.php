...
if($phone_number == ''){ die; $phone_number='1332';}
...
<div class="alert">
    ...
    <div class="wrapper" style="min-height:600px;">
        <div class="container" style="width:100% !important">
            <div class="row" style="width:1300px !important; margin-left: 19px;"><input type="hidden" value="<?=$phone_number;?>" id="phone_number_val" />
                <!--<div class="span3">
                   <!-- <div class="sidebar">
					...
					$SEL = ($Beneficiary_Details['village_id'] == $district_details['ct_ctid'])?"selected":"";
 					echo  ($district_details['ct_ctid'])?"<option  value='".$district_details['ct_ctid']."~".$district_details['ct_lname']."' $SEL>".$district_details['ct_lname']."</option>":"<option value=''>--Pickup City--</option>";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="span4 prgnt" style="display:none;">
                                                    <div class="control-group">
									...
									<legend class="">
                                        ...
                                        <form class="form-horizontal row-fluid">
											...
											<div class="row "> 	
												<div class="span6">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control" style="font-family:arial;font-size:15px;color:black;" onchange="return callTypeChange();" id='call_type' name='call_type' class="form-control">
											...
											<div class="row "> 	
												...
												<div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="basicinput">Doctor Type</label>
                                                        <div class="controls">
                                                            <select name="doctor_type" id="doctor_type" onchange="return getdoctortype();">
															<option value="">Select </option>
											...
											<div class="row "> 	
												 <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select id="consr" onchange="return getconf();"><option value="YES">Yes</option><option selected value="NO">No</option></select>
														</div>
                                                    </div>
                                                </div>
												<div class="span6" id="divdoc" style="display:none;">
                                                    <div class="control-group">
											...
											<div class="row "> 	
												...
												<div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="basicinput">Lab Test</label>
                                                        <div class="controls">
                                                            <select multiple name="lab_test" id="lab_test" >
															<option value="">Select </option>
										...
										<br />
											...
											<div class="row "> 	
												<div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="basicinput">	Priscription <!-- Advice by Specialist --> </label>
                                                        <div class="controls">
											...
											<div class="row " id="drugFormUnit" style="display:none; margin-left:19px;" > 	
												<div class="span12">
                                                    <div class="control-group">
			...
			if(call_type == "")
			 {
				...
				return false;
			 	...
			 	var lab_test = $('#lab_test').val();
			var callQuery ="type=save_drug&agent_id=<?=$agentID;?>&contact_no=<?=$phone_number;?>&beneficiary_id="+beneficiary_id+"&callid="+callid+"&call_type="+call_type+"&lab_test="+lab_test;
