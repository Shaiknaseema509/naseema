                        ...
                        xmlHttp.onreadystatechange=function()
                         {
                                var Response = null;
                                Response = xmlHttp.responseText;
				var end_call_url = "http://<?=$GLOBALS["host_ip"];?>/ConVox3.0/Agent/callcontrol.php?ACTION=CLOSE&convoxid=<?=$_REQUEST["convoxuid"];?>&agent_id=<?=$_REQUEST["agentid"];?>&disposition=CALLTYPE1";
                		//alert(end_call_url);
        ...
        <div class="col-md-9" >	  
          <div class="row" >			 
				...
				<div class="col-md-3" style="font-family:arial;font-size:16px;color:black;background-color: #9cbdff"> उप केंद्र का नाम : <?php echo $Beneficiary_Details['SubCentre_Name'];?>  </div>
				 ...
				 <div class="col-md-3" style="font-family:arial;font-size:16px;color:black;background-color: #9cbdff"> एसोसिएटेड आशा का नाम : <?php echo $Beneficiary_Details['ASHA_Name'];?></div> 
