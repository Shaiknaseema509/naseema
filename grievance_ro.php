...
<div class="alert custm_alrt_color" style="margin:0px 25px;padding: 15px;">
    ...
    <div class="wrapper custm_wrapper" style="min-height:600px;padding-top:0px!important">
            ...
            <div class="row" style="width:100% !important"><input type="hidden" value="<?=$phone_number;?>" id="phone_number_val" />
                <div class="span3">
                    <div class="sidebar">
						...
						$calltype_query = "SELECT call_type_id,call_type_name FROM m_call_type  WHERE call_type_name='Grievance' AND is_active=1 AND is_valid=1 ORDER BY order_by ASC;";
                     ...
                     <?php $rdata = mysql_fetch_array(mysql_query("SELECT `benificiery_surname`,`beneficiary_last`,`call_id`,`beneficiary_name`,`age`,`Gender`,`district_name`,`block_name`,`village_name` FROM `registration` WHERE `contact_no`='".$phone_number."'"));?>
			 ...
			 <div class="span9">
                    <div class="content">
                        <section id="section_one" style="min-height: 354px;">
                            <div class="btn-controls" style="color:#000;background-color: #e1dfdf;border: 1px solid #eedcdc; min-height:515px;max-height:400px;overflow-x: hidden;">
		...
		<tr>
			...
			<td>			
			<select class="form-control custm_input_form" id="Compliant">
		...
		<tr>			
			...
			<td><select class="form-control custm_input_form" id="Designation" name="Designation">  
		...
		<tr>
			...
			<td><input class="form-control custm_input_form" type="text" id="goc" /></td>
				...
				<td class="custm_label_txt">Industry</td>
			<td><input class="form-control custm_input_form" type="text" id="goc" /></td>
			...
			<!--<td class="custm_label_txt">Facility Type</td>
			<td><select id="Facility" class="form-control custm_input_form" name="Facility" >
		...
		<td><input type="button" onclick="conference_call(spoccontact.value)" id="btnsa" value="Call" class="form-control btn btn-danger" style="width:40px" </td>
		<td> <input type="button" class="btn btn-danger" value="Submit" id="btngre" onclick="return saveSubmit();" /></td> 
		</tr>
                       ...
                       ?>
									...
									<div class="custm_row">
									<div class="custm_col_6 control-group-ggh" style="display:none">
									<div class="custm_width" >
									        <div class="custm_label">
