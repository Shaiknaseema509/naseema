...
var xmlHttp=newHttpObject();
	...
	if(spocname == "")	
	  ...
	  var callQuery="type=SaveBeneficiary&agent_id=<?=$agentID;?>&contact_no=<?=$phone_number;?>&spoccontact="+spoccontact+"&Others="+Others+"&sEmail="+sEmail+"&Facility="+Facility+"&spocname="+spocname+"&callerEmail="+callerEmail+"&city_name1="+city_name1+"&tehsil1="+tehsil1+"&rdate="+rdate+"&District="+District+"&call_id="+call_id+"&noc="+noc+"&designation1="+designation1+"&remarks_ro="+remarks_ro+"&complaintagainst="+complaintagainst+"&industryname="+industryname+"&landmark="+landmark+"&goc="+goc+"&Compliant="+Compliant+"&facility_name="+facility_name;
		//alert(callQuery);
