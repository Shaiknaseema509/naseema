...
<script>
	...
	newHttpObject = function()
	{
	 ...
	 function GetEmergencyDetails(CallTypeID)
         {
...
<body onload='GetEmergencyDetails()'>
	<div class="alert">
	...
	<div class="row" style="background-color: #000080 ">
		 ...
		 <div class="col-md-3 header "><span> Call ID :</span> <span id="callid" ><?=$Callid;?></span> </div>
        ...
        <div class="col-md-9" >	  
          <div class="row" >			 
				...
				<div class="col-md-3 blueclass" style="font-family:arial;font-size:14px;color:black;"> &nbsp; 
				 ...
				 <div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;">Past History:<input id="past_history" name="past_history" type="text" value="" style="font-family:arial;font-size:14px;color:black;" class="col-md-12"></div>
				
				 <div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;">Present Complaint:<input type="text" id="present_complaint" onkeypress="return allowValidKey(event,'text');" name="present_complaint" value="" style="font-family:arial;font-size:14px;color:black;" class="col-md-12"> </div> 	
				 
				<div class="col-md-12 blueclass " style="font-family:arial;font-size:15px;color:black;">Advice Given By:<input id="advice_given" name="advice_given" type="text" onkeypress="return allowValidKey(event,'callername');" value="" style="font-family:arial;font-size:14px;color:black;" class="col-md-12"></div>
