...
if($phone_number == '') $phone_number='7227018169';
	...
	function endCall()
	 {
		...
		var xmlHttp=newHttpObject();
                if(xmlHttp)
                 {
                        var callQuery = "action=CLOSE&agent_id=<?=$agentID;?>&call_id="+call_id+"&call_type_id="+callType+"&callTypedup="+callTypedup+"&subCatMul="+subCatMul;
                      //  alert(callQuery);//return false;
                        xmlHttp.open("POST","save_inbound_questions.php",true);
                        xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
                        xmlHttp.send(callQuery);
                                    ...
                                    <div class="control-group" style="float:right">
									 ...
									 <div class="span6 subCatSuspect" style="margin-left:-8px;display:none">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
												<select  id="subCatMul" name="subCatMul[]"> 
