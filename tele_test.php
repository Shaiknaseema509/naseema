...
if($phone_number == '') $phone_number='12';
...
function save_details1()
{
	...
	if(confer == 'YES')
	{
		var doc = document.getElementById('consr').value;
		if(doc == '' || doc == 0)
		{
											...
											<div class="row "> 	
												 <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select id="consr"><option value="YES">Yes</option><option selected value="NO">No</option></select>
														</div>
                                                    </div>
                                                </div>
												<div class="span6" id="divdoc">
                                                    <div class="control-group">
											...
											<div class="row "> 	
												...
												<div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="button" id="save_Details" class="btn btn-success" name="abds" value="Save Details" style="display:none;" onclick="return  save_details1();" />
														</div> 
                                                    </div>
                                                </div>   
												<div class="span6" >
	...
	save_details2();
		...
		if(xmlHttp)
		 {  
			...
			var callQuery ="type=save_drug&agent_id=<?=$agentID;?>&contact_no=<?=$phone_number;?>&beneficiary_id="+beneficiary_id+"&callid="+callid+"&call_type="+call_type;
