...
switch($action)
{
   case 'SaveBeneficiary':
		...
		{			 
			$Query123	= "update grievance SET spocId='".$spocId."',complaintId='".$Compliant."', Others='".$Others."',contact_no='".$contact_no."',agent_id='".$agent_id."',escalationboard='".$escalationboard."',
		complaintagainst='".$complaintagainst."',callerEmail='".$callerEmail."',industryname='".$industryname."',landmark='".$landmark."',remarks_ro='".$remarks_ro."',
		designation1='".$designation1."', facility_type_id='".$Facility[0]."',facility_id='".$facility_name[0]."',
		nComplaint='".$noc."',rDepartment='".$Department."', sector='".$sector."',gistComplatint='".$goc."', rdate='".$rdate."',   district_id='".$district_id[0]."', 
		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."', 
		village_name='".$village_id[1]."',status='".$status."',closedTime=now(),file_name='".$file_name."' where call_id='".$call_id."'";
		...
		//$Query123	= "insert into  escalationresult_live SET spocId='".$spocId."',dateTime=now(),escalationLevelId='1',escalationLevelName='".$spocName."',
...
/*
	...
	case 'updategreven':   
		...
		complaintagainst='".$complaintagainst."',callerEmail='".$callerEmail."',industryname='".$industryname."',landmark='".$landmark."',remarks_ro='".$remarks_ro."', designation1='".$designation1."',  facility_type_id='".$Facility[0]."',facility_id='".$facility_name[0]."',
		nComplaint='".$noc."',rDepartment='".$Department."',sector='".$sector."', gistComplatint='".$goc."', rdate='".$rdate."',   district_id='".$district_id[0]."', 
		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."', spocremarks='".mysql_escape_string($spocremarks)."',
		village_name='".$village_id[1]."',status='".$status."',closedTime=now(),file_name='".$file_name."' where call_id='".$call_id."'";	
