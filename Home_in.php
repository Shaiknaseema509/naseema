...
if($phone_number == '') $phone_number='9989394393'; //738640013251
//if($convoxID == '') $convoxID=rand(1233333333,9016459848);
...
<script>
	...
	function callTypeChange()
	{
		...
		if(callType ==9999 || callType == 35 || callType == 36 || callType == 39 || callType == 52 || callType == 55)
		{			
			if(callType == 36)
			{
				 $('.subCatSuspect').show();
			...
			else if(callType == 39)
			{
				 ...
				 $('.control-group-ggh123').hide();
				 $('#TransferP').show();
			}

			 
			else if(callType == 52 || callType == 55)
			{
				$('#endcall').hide();
				//$('#endcall').val('Submit');
				$('#endcallClose').hide();
	...
	function endCall1()
	 {
		...
		var cat_sub_directory =  '0'; //document.getElementById('cat_sub_directory').value;
		var callTypes  = document.getElementById('CallTypeSS').value.split('~');
		var callType = callTypes[0]; 
		var callTypedup = callTypes[0]; 
		if(callType == 9999)
	...
	{  
		...
		if(callType ==1  || callType ==49 || callType ==6)
		{ 			 
			 var bids=document.getElementById('bids').value; 
			 if(bids ==0)
			 {
		...
		var xmlHttp=newHttpObject();
			...
			$('#CallTypeSS').val('9999~valid');
			 document.getElementById('CallTypeSS').disabled=false;	
	}
	...
	function SaveCategory(Action,CategoryID,SubCategoryID,QuestionID,ResponseID)
	 {
		...
		var callTypedup = callTypes[0]; 
			 ...
			 var bids=document.getElementById('bids').value; 
                ...
                if(xmlHttp)
                {
					var abc= document.getElementById('CallTypeSS').value;
			var transfer_split = document.getElementById('CallTypeSS').value.split('~'); //alert(transfer_split);
			var call_transfer = transfer_split[0]; //alert(queue_id);
			var tf_queue_name = transfer_split[1];
			var queue_id = transfer_split[0];
		...
		if(xmlHttp)
		 {
			...
			// var prgnts	= document.getElementById('prgnts').value;
	...
	function endCall()
	 {
		...
		if(callType ==56 || callType ==53  || callType ==54 || callType ==4 || callType ==6 || callType ==38 || callType ==50 || callType ==51 || callType ==20 || callType ==22 || callType ==24 || callType ==25 || callType ==26 || callType ==28 || callType ==29 || callType ==30 || callType ==31 || callType ==32 || callType ==33  || callType ==34  || callType ==35 || callType ==36 || callType ==37 || callType == 39)
		{ 
			var beneficiary_id =  document.getElementById('beneficiary_ids').value;
			if(beneficiary_id =='' || beneficiary_id == 0)
			{
...
<div class="alert custm_alrt_color" style="margin:0px 25px;padding: 15px;">
    ...
    <div class="wrapper custm_wrapper" style="min-height:600px;padding-top:0px!important">
        <div class="container" style="width:100% !important">
			...
			<div style="height:50px; background-color:#308ebb;margin-bottom:6px">
			   <h2 style="color:#fff; padding-left:40px;padding-top:3px;">Shramik Sahayak Helpline</h2>
			</div>
			 ...
			 <div class="span9">
                                        ...
                                        <form class="form-horizontal row-fluid">
                                            <div class="row custm_row">
                                                ...
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">First Name<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
                                                ...
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Middle Name<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
                                                            <input type="text" id="beneficiary_surname" value="<?php echo $Beneficiary_Details['benificiery_surname'];?>"
															onkeypress="return allowValidKey(event,'callername');" onkeyup="return removeSP('beneficiary_surname');"  value="" placeholder="Type Middile Name..." class="form-control custm_form_input">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row custm_row">
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Last Name<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
                                                            <input type="text" id="beneficiary_lname" onkeypress="return allowValidKey(event,'callername');"  value="<?php echo $Beneficiary_Details['beneficiary_last'];?>" onkeyup="return removeSP('beneficiary_lname');"  value="" placeholder="Type Last Name..." class="form-control custm_form_input">
                                                        </div>
                                                    </div>
                                                </div>
				...
				onkeypress="return allowValidKey(event,'number');"   />
				                                    <div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Age<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
                                            ...
                                            <div class="row custm_row">
                                                ...
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Gender<b aria-required="true">*</b></label>
													</div>
                                            ...
                                            <div class="row custm_row"> 
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">District<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
				...
				?>		
												...
												<div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Taluka/Block<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
		...
		<!--		<option value=''>Select Tehsil</option>-->
				...
				?>	
												...
												<div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Village/City<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
 					...
 					echo  ($district_details['ct_ctid'])?"<option  value='".$district_details['ct_ctid']."~".$district_details['ct_lname']."' $SEL>".$district_details['ct_lname']."</option>":"<option value=''>--Pickup City--</option>";
                                            ...
                                            <div class="row custm_row">
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Landmark<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
...
<textarea id='address1' class="form-control custm_form_input" name='address1' readonly  placeholder="" class="span12"><?php //echo $Beneficiary_Details['address'];?></textarea>
										   ...
										   <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="custm_label_text" for="basicinput">Residence<b aria-required="true">*</b></label>
													</div>
                                                        <div class="custm_input">
                                                          <select id="residence" name="residence" class="form-control custm_form_input custm_form_select">
                       ...
                       ?>
                                     ...
                                     <div id="hidediv" class="control-group" style="float:right">
                                        <div class="controls">
                                            ...
                                            <div style="float:left;margin-right: 15px;">
                                                <button type="button" class="btn btn-large btn-danger" id="endcallClose" onclick="endCall();" >Close</button>
						...
						?>
									 ...
									 <div class="custm_col_6" >
											<div class="span6 subCatSuspect" style="margin-left:-8px;display:none;width:100% !important">
                                            <div class="control-group">
											    <div class="custm_label">
