...
if($phone_number == '') $phone_number='8801492717';
			 ...
			 <div class="span9">
                    <div class="content">
                        <section id="section_one" style="min-height: 450px;">
                            <div class="btn-controls" style="color:white;background: radial-gradient(ellipse farthest-corner at center center, rgba(0,0,0,0.5) 20%, rgba(0,0,0,0.85) 100%) repeat scroll 0% 0%; min-height:590px;max-height:510px;overflow-x: hidden;overflow-y:scroll">
...
<textarea id='address' class="form-control" name='address'  placeholder="Enter Landmark..." class="span12"><?php echo $Beneficiary_Details['address'];?></textarea>
											...
											<div class="row">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="basicinput"> LBS Address  </label>
                                                        <div class="controls">
<textarea id='address1' class="form-control" name='address1' readonly  placeholder="" class="span12"><?php //echo $Beneficiary_Details['address'];?></textarea>
													<?php /*	<input type="text" id='address' class="form-control" name='address' value="<?php echo $Beneficiary_Details['address'];?>"  placeholder="Enter Landmark..." class="span12"> */ ?>
                                                ...
                                                <div class="span6"  >
                                                    <div class="control-group">
                                                        <div class="controls">
														Latitude <input id="lat" readonly> Longitude <input id="long" readonly> Name <input id="names" readonly>
														</div>
                                                    </div>
                                                </div>
                                            </div><br />
                                            <div class="row">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
											<textarea id='remarks_1' class="form-control" name='remarks_1'  placeholder="" class="span12"><?php echo $Beneficiary_Details['remarks_1'];?></textarea>
													<?php /*	<input type="text" id='address' class="form-control" name='address' value="<?php echo $Beneficiary_Details['address'];?>"  placeholder="Enter Landmark..." class="span12"> */ ?>
                       ...
                       ?>
									...
									<div class="span6 control-group-ggh" style="margin-left:-8px;display:none">
                                                <label class="control-label" for="basicinput">Sub Call Type</label> 
                                                <div class="controls">
                                                    <select id="CallTypeSSub"    data-placeholder="Select here.." class="span6">
