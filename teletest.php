                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control" style="font-family:arial;font-size:15px;color:black;" id='call_type' name='call_type' class="form-control">
																<?php $ab= mysql_query("SELECT `call_type_id`,`call_type_name` FROM `m_call_type` WHERE is_active = 1");
											...
											<div class="row "> 	
												...
												<div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="sysdoc" id="sysdoc" class="select_combo">
															<option value="">Select Doctor</option>
																<?php $ab= mysql_query("SELECT `DRID`,`DName`,`MobileNo`,`Specialization` FROM `tbldoctormaster` ;");
																while($dig =mysql_fetch_array($ab))
																{?>
