...
function SaveInformationDirectoryMedical(sub_directory)
		...
		if(xmlHttp)
		 {
			...
			var callQuery = "type=SAVEMEDICAL&complaint="+complaint+"&remarks="+remarks+"&advice="+advice+"&outputs="+output+"&call_id="+call_id+"&bskpoint="+bskpoint+"&diagnosis="+diagnosis+"&agent_id=<?=$agentID;?>";
			//alert(callQuery);
	   ...
	   function Savedrugdetails()
	 {
		 ...
		 //if ($('.dosageData').length>5){
			//  alert("Only 5 Drug will ADD.  ");
			// return;
		 //}
		...
		if(xmlHttp)
		 {
			...
			var callQuery = "type=SAVEMEDICALDOSAGES&call_id="+call_id+"&countUsage="+numItems+"&agent_id=<?=$agentID;?>";
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="row custm_row_m_r">
<!--<div class="col-md-3" >-->
			   <div class="span3">
			   <div class="custm_span3_m_l">
                    <div class="sidebar">            
...
<?php $rdata = mysql_fetch_array(mysql_query("SELECT `benificiery_surname`,`beneficiary_last`,`call_id`,`beneficiary_name`,`age`,`Gender`,`district_name`,`block_name`,`village_name` FROM `registration` WHERE `call_id`='".$callids."'"));?>					
                          ...
                          <ul class="widget widget-menu unstyled">
                            <li style="line-height:37px;background-color:#2d2b32;color:white;">
						 ...
						 <ul class="widget widget-menu unstyled" >
                            ...
                            <li style="line-height:37px;background-color:#2d2b32;color:white;">
							 ...
							 <li style="line-height:37px;background-color:#2d2b32;color:white;">
								...
								<label class="control-label" for="basicinput" style="padding-left: 20px;padding-right:5px;">Transfer Group </label>
									<select name="call_transfer" id="call_transfer"  data-placeholder="Select here.." class="span12" style="border: 1px solid #ced4d7;border-radius: 4px;">
						...
						<li style="line-height:37px;background-color:#2d2b32;color:white;">
							 <button type="button"  onclick="transfer_to_queue('TRANSFER');" id="TransferP" class="btn btn-large btn-danger">Transfer</button>
							 </li>
                        </ul>
    ...
    <form>
	<div class="row">
        <div class="container" style="max-height:578px; overflow-y:scroll" >
            <div style="background: radial-gradient(ellipse farthest-corner at center center) repeat scroll 0% 0%;background-color:#e1dfdf;border: 1px solid #eedcdc; ">
                <div class="form-group">
                    <fieldset>
                        ...
                        <table cellpadding="2" id="not104fever" cellspacing="2" width="100%" style="border: 0px solid #fff;margin-top:7px;">
                            <tr>
                                <td style="width:12%;" class="custm_padng_left">Sympton :</td>
...
<input type="text" name="Search" id="searchInput" onkeyup="myFunction()" class="form-control custm_input_border custm_search_input"  placeholder="DISEASE SUMMURIES SEARCH" />
...
<?php      mysql_query('SET character_set_results=utf8');
                                                     ...
                                                     { ?>  
																  <tr>
                                                                        ...
                                                                        <td style="color:black;padding-left: 15px;">
                                                                       ...
                                                                       <input type="hidden" value="<?php echo $row['mi_DocPath_Tel'];?>" id="abcd_<?php echo $i;?>" />
                                                                            <input style="cursor:pointer" type="button" onclick="return saveGovtDetails('<?php echo $row['mi_DocPath_Tel'];?>','abcd_<?php echo $i;?>');" id="btnSmoking" class="btn btn-warning btn-sm" align="center" value="View" style="width: 60px;color:white;float:right">
                                                                        </td>
                                                                    </tr>
                                                                     <?php $i++; }?>  
                                                                </table>
							...
							<tr>
                                <td class="custm_padng_left">Remarks </td>
                                <td align='nowrap' class="custm_padng_right">
                                    <textarea id="remarks" rows="1" cols="30" class="form-control custm_input_border"></textarea>
                                </td>
								
								<td class="custm_padng_left" style="margin-top:10px">Provisional Diagnosis  </td>
								<td align='nowrap' class="custm_padng_right">
                            ...
                            <tr>
                                      ...
                                      <td class="custm_padng_left">Basic Ailment </td>
										<td align='nowrap' class="custm_padng_right">
                                ...
                                <td><button type="button" id="myBtn" class="custm_prescriptn"> Prescription </button></td>
                                <td align="right">
...
<input type="button" class="btn btn-danger" id="idmdn" align="center" value="Conference" onclick="conCall();" style="margin-right: 14px;" >
		...
		if(xmlHttp)
		 {
			 ...
			 var x = document.getElementById("ddud").rows.length;
