...
var end_call_url = "http://<?=$GLOBALS["host_ip"];?>/ConVox3.0/Agent/callcontrol.php?ACTION=CLOSE&convoxid=<?=$convoxID;?>&agent_id=<?=$agent_id;?>&disposition=1";
	...
	<div class="row" style="background-color: #000080 ">
		 ...
		 <div class="col-md-3 header "> तारीख : <?=date('d-m-Y',strtotime($Beneficiary_Details["createdon"]));?> </div> 
		 <div class="col-md-3 header "> पहर : <?=date('H:i:s',strtotime($Beneficiary_Details["createdon"]));?></div>
	</div>  
	</div>
        <?php
	...
	<div class="form-group" > 
		...
		<tr>
			...
			value="<?=$Beneficiary_Details['beneficiary_name'];?>"   /></td>
		</tr><tr><td></td></tr>	
		<tr>
					
			<td align='right' style="font-family:arial;font-size:15px;color:black;" >Middle Name  :</td>
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
			<input type="text" id='beneficiary_surname' name='beneficiary_surname' onkeypress="return allowValidKey(event,'callername');" 
			value="<?=$Beneficiary_Details['beneficiary_last'];?>"   /></td>
		</tr><tr><td></td></tr>	
		...
		<tr>
			...
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
				<input type="text" id='beneficiary_lname' name='beneficiary_lname' 
				onkeypress="return allowValidKey(event,'callername');" value="<?=$Beneficiary_Details['benificiery_surname'];?>"  /></td>
		</tr><tr><td></td></tr>	
		...
		<tr>
			...
			<td align='nowrap' tyle="font-family:arial;font-size:15px;color:black;"><span id="mother_span" name="mother_span">
			<input type="text" id="mother" name="mother" onkeypress="return allowValidKey(event,'callername');" value="<?=$Beneficiary_Details['aPhoneno'];?>" /></span></td>
		</tr>	
		</tr><tr><td></td></tr>
		<tr>
		...
		<!--		<option value=''>Select Tehsil</option>-->
				<?php
			        echo"<option value=''>--Enter Block --</option>";
		...
		<tr><tr><td></td></tr>
			...
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;"><span id="city_name_span" name="city_name_span">
				...
				<?php
			        echo "<option value=''>--Enter Village--</option>";
