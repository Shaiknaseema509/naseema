...
<div class="alert">
    ...
    <!-- /navbar -->
    <div class="wrapper" style="min-height:350px;padding:0px">
	      <div class="container" style="width:100% !important">
            <div class="row"><input type="hidden" value="<?=$phone_number;?>" id="phone_number_val" />
            
             

			 <div class="custm_right_width">
                    <div class="content">
                        <section id="section_one" style="min-height: 350px;">
                            <div class="btn-controls" style="color:white;background: radial-gradient(ellipse farthest-corner at center center) repeat scroll 0% 0%; min-height:350px;max-height:350px;overflow-x: hidden;overflow-y:scroll;background-color:#e1dfdf;border: 1px solid #eedcdc; ">
                                            ...
                                            <div class="row custm_row">
												...
												<div class="custm_width">
                                                    <div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Phone Number</label>
														</div>
                                                ...
                                                <div class="custm_col_4" style="display:none">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Transfer Group</label>
														</div>
                                                        <div class="custm_input">
												...
												<div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Caller Name</label>
														</div>
                                                        <div class="custm_input">
                                                            <input type="text" id="caller_name" onkeypress="return allowValidKey(event,'callername');" value="<?php echo $Beneficiary_Details1['caller_name'];?>" onkeyup="return removeSP('beneficiary_lname');"  placeholder="Type Last Name..." class="form-control custm_form_input">
                                                        </div>
                                                    </div>
                                                </div>
												 ...
												 <div class="custm_col_4"  >
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Patient Name</label>
														</div>
                                                        <div class="custm_input">
				...
				<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Age</label>
														</div>
                                                        <div class="custm_input">
														<div class="custm_year_width">
                                                           <select name="monthyear" id="monthyear" onchange="return checkPrgenet()" class="form-control custm_form_input" >
												...
												<input type="text" id='age' class="form-control custm_form_input" name='age' maxlength=3
                                                ...
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">GENDER </label>
													</div>
												...
												<div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Alternative Number</label>
                                                    </div>
														<div class="custm_input">
                                            ...
                                            <div class="row custm_row">
                                                ...
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">District</label>
													</div>
                                                        <div class="custm_input">
				...
				?>		
												...
												<div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Taluka/Block</label>
													</div>
                                                        <div class="custm_input">
		...
		<!--		<option value=''>Select Tehsil</option>-->
				...
				?>	
                                                ...
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Village/City</label>
													</div>
                                                        <div class="custm_input">
 					...
 					echo  ($district_details['ct_ctid'])?"<option  value='".$district_details['ct_ctid']."~".$district_details['ct_lname']."' $SEL>".$district_details['ct_lname']."</option>":"<option value=''>--Pickup City--</option>";
                                            ...
                                            <div class="row custm_row">
                                                <div class="custm_col_4">
                                                    <div class="custm_width">
													<div class="custm_label">
                                                        <label class="control-label custm_label_text" for="basicinput">Landmark </label>
													</div>
                                                        <div class="custm_input">
                                                            <input type="text" id='address' class="form-control custm_form_input" name='address' value="<?php echo $Beneficiary_Details1['address'];?>"  placeholder="Enter Landmark..." class="span12">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="control-group" style="float:right;">
												 ...
												 <div style="float:left;padding-right: 20px;" class="abcdtransergroup">
...
.alert { top:0px;
				...
				.custm_year_width .custm_form_input{
					width:45% !important;
					float:left;
				}
				.d-f{
