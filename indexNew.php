...
if($phone_number == '') $phone_number='7386400122';
	...
	function endCall()
	 {
		...
		if(callType ==1  || callType ==2  || callType ==3 || callType ==4 || callType ==6 || callType ==5 || callType ==9 || callType ==13 || callType ==15 || callType ==19 || callType ==20 || callType ==22 || callType ==24 || callType ==25 || callType ==26 || callType ==28 || callType ==29 || callType ==30 || callType ==31 || callType ==32 || callType ==33  || callType ==34  || callType ==35 || callType ==36 )
		{ 
			var beneficiary_id =  document.getElementById('beneficiary_ids').value;
			if(beneficiary_id =='' || beneficiary_id == 0)
			{
...
<textarea id='address' class="form-control" name='address'  placeholder="Enter Landmark..." class="span12"><?php echo $Beneficiary_Details['address'];?></textarea>
                                            ...
                                            <div class="control-group" style="float:right">
                                                <div class="controls">
                                                    <input type="button" onclick="return saveBeneficiaryDetails();" class="btn btn-large btn-primary" value="Registration" />
                                                </div>
                                            </div>
                                            <br />
                                            <hr />
                                    ...
                                    <div class="row">
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select id="CallTypeSS"   data-placeholder="Select here.." class="span12">
                                    ...
                                    <div class="control-group" style="float:right">
                                        <div class="controls">
                                            <div style="float:left" class="abcdtransergroup">
                                                <button type="button" style="<?php if($Beneficiary_Details['registration_id'] == ''){ echo 'display:none;';}?>" onclick="transfer_to_queue('TRANSFER');" id="TransferP" class="btn btn-large btn-primary">Transfer</button>
                                            </div>
