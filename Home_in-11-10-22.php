...
if($phone_number == '') $phone_number='738640013251'; //738640013251
...
<script>
	...
	function callTypeChange()
	{
		...
		if(callType ==9999 || callType == 35 || callType == 36 || callType == 39 || callType == 47)
		{
			if(callType == 36)
			{
				 $('.subCatSuspect').show();
	...
	function endCall1()
	 {
		...
		var CallTypeSSubb1 =document.getElementById('CallTypeSSubb').value;
		if(callType ==39)
		{ 
		...
		var xmlHttp=newHttpObject();
                if(xmlHttp)
                 {     
                        var callQuery = "action=CLOSESCHEME&agent_id=<?=$agentID;?>&cat_sub_directory="+cat_sub_directory+"&remarks="+remarks+"&call_id="+call_id+"&call_type_id="+callType+"&CallTypeSSub="+CallTypeSSub1+"&CallTypeSSubb="+CallTypeSSubb1+"&callTypedup="+callTypedup+"&cou="+ij+ccd;
	...
	function endCall()
	 {
		...
		if(callType ==1  || callType ==2  || callType ==3 || callType ==4 || callType ==6 || callType ==5 || callType ==9 || callType ==13 || callType ==19 || callType ==20 || callType ==22 || callType ==24 || callType ==25 || callType ==26 || callType ==28 || callType ==29 || callType ==30 || callType ==31 || callType ==32 || callType ==33  || callType ==34  || callType ==35 || callType ==36 || callType ==37 || callType == 39 || callType ==47)
		{ 
			var beneficiary_id =  document.getElementById('beneficiary_ids').value;
			if(beneficiary_id =='' || beneficiary_id == 0)
			{
		...
		var xmlHttp=newHttpObject();
                if(xmlHttp)
                 {
                        var callQuery = "action=CLOSE&agent_id=<?=$agentID;?>&call_id="+call_id+"&call_type_id="+callType+"&CallTypeSSub="+CallTypeSSub1+"&CallTypeSSubb="+CallTypeSSubb1+"&callTypedup="+callTypedup+"&subCatMul="+subCatMuls;
                      //  alert(callQuery);//return false;
                        xmlHttp.open("POST","save_inbound_questions.php",true);
                        xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
                        xmlHttp.send(callQuery);
    ...
    <div class="wrapper custm_wrapper" style="min-height:600px;padding-top:0px!important">
        <div class="container" style="width:100% !important">
			...
			<div style="height:50px; background-color:#308ebb;margin-bottom:6px">
			   <h2 style="color:#fff; padding-left:50px;padding-top:3px;">Shramik Sahayak Helpline</h2>
			</div>
                                            ...
                                            <div class="row custm_row">
                                                ...
                                                <div class="custm_col_4">
													...
													<div class="custm_label">
                                                        ...
                                                        <div class="custm_input">
                                                            <input type="text" id="beneficiary_surname" onkeypress="return allowValidKey(event,'callername');" onkeyup="return removeSP('beneficiary_surname');"  value="" placeholder="Type Middile Name..." class="form-control custm_form_input">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row custm_row">
                                                <div class="custm_col_4">
													...
													<div class="custm_label">
                                                        ...
                                                        <div class="custm_input">
                                                            <input type="text" id="beneficiary_lname" onkeypress="return allowValidKey(event,'callername');" onkeyup="return removeSP('beneficiary_lname');"  value="" placeholder="Type Last Name..." class="form-control custm_form_input">
                                                        </div>
                                                    </div>
                                                </div>
