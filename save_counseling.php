...
$counCallType 	= $_POST["counCallType"];
...
switch($action) 
{
  ...
  case 'SEARCHHOSPITAL': 
   ...
   if($subSubDirectoryID =='') $subSubDirectoryID=1;
	...
	if($call_id!='')
	 {
		 $Query = "INSERT INTO `counselling` SET callType='".$counCallType."',`pph`='".$pph."',`callid`='".$call_id."',`category_id`='".$directory_id."',`subcategory_id`='".$subdirectory_id."',
