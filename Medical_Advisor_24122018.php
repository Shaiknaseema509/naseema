...
<script>
	...
	function endCall()
	 {
		...
		var disposition = "";
		var Queue = "<?=strtoupper($_REQUEST["Queue"]);?>";
		if(Queue == "MEDADV_MQ")
		 {
                ...
                if(xmlHttp)
                 {
                        ...
                        var callQuery = "action=CLOSE&agent_id=<?=$_REQUEST["agentid"];?>&call_hit_referenceno=<?=$call_hit_referenceno;?>&call_type_id="+call_type_id_array[0]+"&call_information_id="+call_information_id+"&beneficiary_id="+beneficiary_id;
                                ...
                                if (xmlHttp.readyState==4 && xmlHttp.status==200)
                                 {
                                        ...
                                        Response = xmlHttp.responseText;
                                        //alert(Response);
					var end_call_url = "http://<?=$GLOBALS["host_ip"];?>/ConVox3.0/Agent/callcontrol.php?ACTION=CLOSE&convoxid=<?=$_REQUEST["convoxuid"];?>&agent_id=<?=$_REQUEST["agentid"];?>&disposition="+disposition;
					//alert(end_call_url);
	...
	<div class="row" style="background-color: #000080 ">
		...
		<?php
                ...
                {
                 ?>
		 <div class="col-md-3 header "> फ़ोन नंबर : <?=$_REQUEST["callernumber"];?> 
		 <img src="images/VIP.png" style='width:50px;height:40px;' /></div>
	...
	<div class="form-group" > 
		...
		<tr>
			<td align='right' style="font-family:arial;font-size:15px;color:black;"><font color="red">*</font>लाभार्थी आईडी :</td>
		...
		<tr>
				...
				<tr>
					<td align=right style="font-family:arial;font-size:15px;color:black;"><font color="red">*</font>कॉल सूचना : </td>
					<td>
						<select style="font-family:arial;font-size:15px;color:black;" name="call_information" id="call_information" class="col-md-10">
          ...
          <div class="row" >			 
				...
				<div class="col-md-3 blueclass" style="font-family:arial;font-size:14px;color:black;"> &nbsp; 
				 ...
				 <div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;"> सलाह द्वारा मांगे :  <span id="Advice_sought_by_span" name="Advice_sought_by_span"><input type="text"id="Advice_sought_by" name="Advice_sought_by" value="<?echo $agent_id;?>" style="font-family:arial;font-size:14px;color:black;" class="col-md-12" readonly/></div> 
                                ...
                                <div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;"><br>
				...
				<div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;"><font color="red">*</font>विगत इतिहास :<span id="past_history_span" name="past_history_span"><textarea id="past_history" name="past_history" style="font-family:arial;font-size:14px;color:black;width:5500px;height:40px;" class="col-md-12"></textarea></span></div>
				
			 <div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;"><font color="red">*</font>वर्तमान शिकायत :<span id="present_complaint_span" name="present_complaint_span"><textarea id="present_complaint" name="present_complaint" style="font-family:arial;font-size:14px;color:black;width:5500px;height:40px;" class="col-md-12"></textarea></span></div> 	
				 
				<div class="col-md-6 blueclass " style="font-family:arial;font-size:15px;color:black`;"><font color="red">*</font>सलाह :<span id="advice_give_span" name="advice_span"><textarea id="advice" name="advice" style="font-family:arial;font-size:14px;color:black;width:5500px;height:40px" class="col-md-12" ></textarea></span></div>
