...
if($call_id =='') $call_id='20190000296216';
...
function referralss(a)
{
	...
	$('.raman').hide();
	$('.level_'+a).show();
	//$('.referralsconcerned').multiselect("clearSelection");
}	
...
<div class="col-md-12" style=""> 
	...
	<table 	class="tble tale-stiped ac" cellspacing="5" cellpadding="5">
		...
		<tr>
			<td>District</td>
			<td><select id="District" class="form-control" onchange='GetRegions(this.value,"1");' disabled >
			<option value=''>Select District</option>
 			...
 			<td>Taluka</td>
			<td><select id="tehsil1" class="form-control" onchange='GetRegions(this.value,"2");' disabled >
			...
			<td>Village</td>
			<td><select id="city_name1" class="form-control" onchange='GetRegions(this.value,"5");' disabled >
	...
	<table 	class="tble tale-stiped ac" cellspacing="5" cellpadding="5">
		...
		<tr>
			...
			<td><select class="form-control" id="calltype" name="calltype" onchange='GetRegions(this.value,"6"); GetRegions(this.value,"7");'>  
				...
				<option value='<?php echo $db['call_type_id'];?>'><?php echo $db['call_type_name'];?></option>
				<?php }?> 
			</select></td> 
		...
		<tr> 
			...
			<td>Remarks</td>
			<td><textarea class ="textarea1" cols="50" rows="2" id="co_remarks" maxlength="500" style="width: 387px; height: 79px;" ></textarea></td> 
