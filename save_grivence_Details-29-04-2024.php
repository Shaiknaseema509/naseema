...
switch($action)
{
   case 'SaveBeneficiary':
		...
		village_name='".$village_id[1]."',mailstatus='0', `date`='".date('Y-m-d H:i:s')."'";
		...
		$Query1234	= "insert into  escalationresult_live SET spocId='".$spocId."',dateTime=now(),escalationLevelId='$escalationID',escalationLevelName='".$spocName."',
		...
		$Query1233	= "insert into  grievanceEscalationLevel SET callid='".$call_id."',lastModfied=now(),levelNo='1'";
		
			mysql_query($Query1233);
		dblog($Query1233);
...
/*
	...
	case 'updategreven':   
		...
		$qu = mysql_query("select call_id from registration_patient where call_id='".$call_id."'");
		...
		if($norows ==0  || $norows =='')
		{
			$Query_1	= "INSERT INTO grievance SET call_id='".$call_id."',spocId='".$spocId."', complaintId='".$Compliant."', Others='".$Others."',contact_no='".$contact_no."',agent_id='".$agent_id."',escalationboard='".$escalationboard."',
		complaintagainst='".$complaintagainst."',callerEmail='".$callerEmail."',industryname='".$industryname."',landmark='".$landmark."',remarks_ro='".$remarks_ro."', designation1='".$designation1."',  facility_type_id='".$Facility[0]."',facility_id='".$facility_name[0]."',
		...
		{			 
			$Query_2	= "update grievance SET spocId='".$spocId."',call_id='".$call_id."',closed_by='".$agent_id."', `source`='Web-SSH',
		status='".$status."',closedTime=now(),spocremarks='".mysql_escape_string($spocremarks)."',file='".$file_name."',
         closed_remarks='".$escalationremarks."',caller_remarks='".$remarks."'		where call_id='".$call_id."'";	
		...
		{
				$Query_3	= "insert into  escalationresult_live SET dateTime=now(),escalationLevelId='$escalationID',
    ...
    break;
	 ...
	 case 'updategrevence': 
		...
		echo $query12 = "select call_id from grievance where call_id='".$call_id."'";
	...
	$qu = mysql_query($query12);
		...
		if($norows ==0  || $norows =='')
		{
			$Query_4	= "INSERT INTO grievance SET call_id='".$call_id."', complaintId='".$Compliant."',contact_no='".$contact_no."',agent_id='".$agent_id."',
		...
		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."', 
		village_name='".$village_id[1]."', `date`=NOW()";
		$d = mysql_query($Query_4);
		dblog($Query_4);
		}			
		else
		{			 
		echo $Query1234	= "update grievance SET spocId='".$spocId."',closed_by='".$agent_id."', `source`='Web-SSH',
		...
		{
				$Query1232	= "insert into  escalationresult SET dateTime=now(),escalationLevelId='$escalationID',
