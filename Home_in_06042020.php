...
if($phone_number == '') $phone_number='9974282770';
	...
	function saveBeneficiaryDetails()
	 {
		...
		var callType = callTypes[1]; 
		 ...
		 var pda= $('#prgnts').val();
		 if(pda == 'T')	$('#cPregency').html('NA');
		 else $('#cPregency').html($('#prgnts').val());
                                            ...
                                            <div class="row">
                                                <div class="span6">
                                                    <div class="control-group">
														...
														<p id="basicinputNumberbeneficiary_ids_label"></p>
													   </div>
                                                    </div>
                                                </div>
