...
switch($action)
 {
   case "CLOSE" :
	...
	$Query5 = "UPDATE call_incident_info SET call_type_id='".$call_type_id."', call_information_id='".$call_information_id."',
	popup_close_time=NOW(),call_end_time=NOW() WHERE callid='".$callid."' ;";
	mysql_query($Query5);
	dblog($Query5);
 ...
 function dblog($Query)
{
  ...
  $log_file = "$log_path/inf_".date("Y-m-d_H").".csv";
