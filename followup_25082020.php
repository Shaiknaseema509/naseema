			...
			if(a == 2)
			 {
					...
					callQuery += "&agent_id=<?=$agentID;?>&caller_id="+caller_id+"&amb_quest="+amb_quest+"&amb_reach_time="+amb_reach_time+"&amb_not_reach_time="+amb_not_reach_time+"&followup_level="+followup_level; 
			 }
...
var xmlHttp=newHttpObject();
	...
	var callQuery="type=notansweredreasonfollowup&agent_id=<?=$agentID;?>&caller_id="+caller_id+"&notanswered="+notanswered;
...
<div class="col-md-12" style=""> 
	...
	<!--		 <td>Complaint Against</td>
		...
		<tr>
			...
			<td><button type="button" id = "btnterminate" class="btn btn-large btn-danger" onclick="notanswereddet();" style='display:none;' >Terminate</button>
			</td>
		</tr>
	...
	<div class="loadPage" id="loadPage">
		<?php $callid=$co_Details['caller_id']; if($co_Details['followup_name'] == 'First Followup')include('followup_1.php');
