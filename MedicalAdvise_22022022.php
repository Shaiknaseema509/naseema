        ...
        if(xmlHttp)
         {
            ...
            var SubDirectoryID = 1; //document.getElementById('sub_directory').value;
            var subSubDirectoryID = 1; //document.getElementById('cat_sub_directory').value;
  ...
  <div class="modal-content">
	...
	<div class="row" style="background-color:">
		...
		<table cellpadding="3" cellspacing="3" class="table-responsive"  >
			<tr>
				<td>
				<select name="GroupId" id="GroupId" onchange="return showHidedrugs(this.value);">
					<option value="">Select</option>
					 <?php       
					 $stmtVILL="SELECT `GroupId`,`GroupName` FROM `druggroups` ORDER BY GroupName ASC;";
			 ...
			 <?php       
				 ...
				 while($row=mysql_fetch_array($resultVILL))
				 {?>
				<tr class="alldrugs <?php echo $row["GroupId"];?>" style="display:none">
					<td>
		...
		<div class=" col-md-8" > 
			<table cellpadding="3" class="table" cellspacing="3" >
				...
				<tr>
					<td style="width:40%">Drug Name </td>
					<td width="25%">Dosage  </td>
					<td width="25%">Usages  </td>
					<td width="25%">Days </td>
