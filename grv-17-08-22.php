...
{	
	  ...
	  var callQuery="type=SaveBeneficiary&agent_id=<?=$agentID;?>&contact_no=<?=$phone_number;?>&spoccontact="+spoccontact+"&sEmail="+sEmail+"&residence="+residence+"&Facility="+Facility+"&spocname="+spocname+"&city_name1="+city_name1+"&tehsil1="+tehsil1+"&rdate="+rdate+"&District="+District+"&call_id="+call_id+"&noc="+noc+"&designation1="+designation1+"&complaintagainst="+complaintagainst+"&callerEmail="+callerEmail+"&industryname="+industryname+"&landmark="+landmark+"&remarks_ro="+remarks_ro+"&goc="+goc+"&Compliant="+Compliant+"&Others="+Others+"&facility_name="+facility_name;
...
<div class="col-md-12" style="color:white;background: radial-gradient(ellipse farthest-corner at center center) repeat scroll 0% 0%;background-color:#e1dfdf;border: 1px solid #eedcdc; ">
	...
	<table 	class="tble tale-stiped ac" cellspacing="5" cellpadding="5">
		...
		<tr>	
			...
			<td class="custm_label_txt"> Residence</td>
			<td><select id="residence" name="residence" class="form-control custm_input_form">
			  <option value="">Select Option</option>
			  <option value="Domicile">Domicile</option>
				<option value="Migrant">Migrant</option></select></td>
