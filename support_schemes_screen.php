...
<tr bgcolor="#000080"> 
<th colspan="4" id="mhtitle"><font color="white" family="arial" size="3px"><center>Support Services Screen</center></font></th>
</tr>
<tr > 
<td colspan=4>
	<div style="font-family:arial;font-size:15px;color:black;font-weight:bold;">Services Details<div>
	<table width="100%"  cellspacing="1" cellpadding="1" border="1">
	 
		<thead><tr><td></td><td><input id="searchInput" onkeyup="myFunction()" value="" placeholder="Type to search" ></td></tr></thead>
		<tbody id="myTable">		 
		 <?php        $i=0;         
                $stmtVILL="SELECT Scheme,EnglishDoc,id FROM m_government_schemes where categoryId=3 ORDER BY order_by desc;";
                ...
                {$i++;?>
				 ...
				 <tr>
					...
					<td style="color:white"> <?=$row['Scheme'];?></td>
					<td> <input class="btn btn-danger" style="cursor:pointer" id="<?=$row['EnglishDoc'];?>" type="button" onclick="return saveGovtDetails111('<?=$row['EnglishDoc'];?>');" value="View" name="save"> </td>
				 </tr>			 
			...
			<tr>
				...
				<td><input value="Sumbit" style="color: #ff0000; font-weight: bold; font-size: 10pt;" id="endcall" type="button" onclick="endCall1();"></td>
			</tr>
