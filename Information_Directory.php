                                ...
                                if (xmlHttp.readyState==4 && xmlHttp.status==200)
                                 {
                                        ...
                                        Response = xmlHttp.responseText;
                                        //alert(Response);
					var end_call_url = "http://<?=$GLOBALS["host_ip"];?>/ConVox3.0/Agent/callcontrol.php?ACTION=CLOSE&convoxid=<?=$_REQUEST["convoxuid"];?>&agent_id=<?=$_REQUEST["agentid"];?>&disposition=INFORMATIONDIRECTORY";
					//alert(end_call_url);
        ...
        <div class="col-md-9" >	  
          <div class="row" >			 
				...
				<div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;display:none;">विगत इतिहास :<span id="past_history_span" name="past_history_span"><input id="past_history" name="past_history" type="hidden" value="<?=$Beneficiary_Details['Past_history'];?>" style="font-family:arial;font-size:14px;color:black;width:5500px;height:40px;" class="col-md-12"></span></div>
				 ...
				 <div class="col-md-3 blueclass " style="font-family:arial;font-size:15px;color:black;display:none;">वर्तमान शिकायत :<span id="present_complaint_span" name="present_complaint_span"><input type="hidden" id="present_complaint" onkeypress="return allowValidKey(event,'text');" name="present_complaint" value="<?=$Beneficiary_Details['present_compalint'];?>" style="font-family:arial;font-size:14px;color:black;width:5500px;height:40px;" class="col-md-12"></span></div> 	
