...
<script>
	...
	function GetCallID()
         {
                ...
                if(xmlHttp)
                 {
                        var callQuery="agentID=<?=$_POST["agentid"];?>";
	...
	<div class="row" >
	 ...
	 <div class="row" style="background-color: #000080 ">
		 ...
		 <div class="col-md-3" style="font-family:arial;font-size:18px;color:white;font-weight:bold;"><span> Call ID :</span> <span id="callid"></span> </div>
