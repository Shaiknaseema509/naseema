...
switch($action)
{
   case 'SaveBeneficiary':
		...
		$remarks1		= $_POST['remarks_1'];
		$remarks_1   = mysql_real_escape_string($remarks1); 
		$status         = $_POST['status'];			
		...
		$Query123	= "INSERT INTO registration SET call_id='".$call_id."', aPhoneno='".$ano."',dob='".$dob."',residence='".$residence."',agent_id='".$agent_id."',beneficiary_last='".$beneficiary_lname."', beneficiary_name='".$beneficiary_name."', benificiery_surname='".$benificiery_surname."', language_id='".$status."',	age='".$age."', age_type='".$age_type."', Gender='".$Gender."', mother='".$mother."',  district_id='".$district_id[0]."', 		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."', 		village_name='".$village_id[1]."', contact_no='".$contact_no."', education_id=0, 		occupation_id=0, marital_status_id=0, relationship_id=0, caste_id=0,		caste_name='0', registered_contact_no='".$contact_no."',aadhar_uid_no='".$aadhar_uid_no."', address='".mysql_escape_string($address)."', createdon=NOW(),remarks_1='".mysql_escape_string($remarks_1)."'";
		...
		{			 
			$Query123	= "update registration SET aPhoneno='".$ano."',dob='".$dob."',agent_id='".$agent_id."',residence='".$residence."',beneficiary_last='".$beneficiary_lname."', beneficiary_name='".$beneficiary_name."', benificiery_surname='".$benificiery_surname."', language_id='".$status."',age='".$age."', age_type='".$age_type."', Gender='".$Gender."', mother='".$mother."',  district_id='".$district_id[0]."', 		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."', 		village_name='".$village_id[1]."', education_id=0, 		occupation_id=0, marital_status_id=0, relationship_id=0, caste_id=0, 		caste_name='0', registered_contact_no='".$contact_no."',aadhar_uid_no='".$aadhar_uid_no."', address='".mysql_escape_string($address)."',remarks_1='".mysql_escape_string($remarks_1)."' where contact_no=".$contact_no;			
			mysql_query($Query123);
			dblog($Query123);
			//mysql_fetch_array(mysql_query("select "));
			//echo "update".$Query123;
		...
		mysql_set_charset('utf8');
		$Queryw	= "INSERT INTO registration_patient SET call_id='".$call_id."', aPhoneno='".$ano."',dob='".$dob."',agent_id='".$agent_id."',
		beneficiary_last='".$beneficiary_lname."', beneficiary_name='".$beneficiary_name."', benificiery_surname='".$benificiery_surname."',
		age='".$age."', age_type='".$age_type."', Gender='".$Gender."', mother='".$mother."',  district_id='".$district_id[0]."',
		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."',
		village_name='".$village_id[1]."', contact_no='".$contact_no."', language_id=0, education_id=0,occupation_id=0, marital_status_id=0,
		relationship_id=0, caste_id=0,caste_name='0', registered_contact_no='".$contact_no."',aadhar_uid_no='".$aadhar_uid_no."', 
		address='".$address."',residence='".$residence."', createdon=NOW(),remarks_1='".mysql_escape_string($remarks_1)."'";
		mysql_query($Queryw);
		dblog($Queryw);
		
		$Query213	= "INSERT INTO registration_patient_history SET call_id='".$call_id."', aPhoneno='".$ano."',dob='".$dob."',agent_id='".$agent_id."',
		beneficiary_last='".$beneficiary_lname."', beneficiary_name='".$beneficiary_name."', benificiery_surname='".$benificiery_surname."',
		age='".$age."', age_type='".$age_type."', Gender='".$Gender."', mother='".$mother."',  district_id='".$district_id[0]."',
		district_name='".$district_id[1]."', block_id='".$block_id[0]."', block_name='".$block_id[1]."', village_id='".$village_id[0]."',
		village_name='".$village_id[1]."', contact_no='".$contact_no."', language_id=0, education_id=0,occupation_id=0, marital_status_id=0,
