...
if($phone_number == '') $phone_number='7600195619';
                                ...
                                if (xmlHttp.readyState==4 && xmlHttp.status==200)
                                 {
									var Response = null;
									Response = xmlHttp.responseText;
									if(beneficiary_id !='') $('#beneficiary_ids').val(Response);
									$('.alert').show();
...
if($Beneficiary_Details['registration_id'] == '') $bids=0;
	else $bids=11;
?>	
	...
	<table cellpadding="5" cellspacing="5" width="100%"  style="border: 1px solid #fff">
		<tr>
			...
			<tr style="display:none" id="mainCalltype">
				...
				<tr>
					<td></td>
					<td><input value="Transfer" style="<?php if($Beneficiary_Details['registration_id'] == ''){ echo 'display:none;';}?>color: #ff0000; font-weight: bold; font-size: 10pt;" type="button" onclick="transfer_to_queue('TRANSFER');" id="TransferP"></td>
				</tr>
				<tr>
	...
	<div class="form-group"  > 
		<table cellpadding="2" id="not104fever" cellspacing="2" width="100%"  style="display:none;border: 1px solid #fff">
		<tr style="display:none">
			<td align='right' style="font-family:arial;font-size:15px;color:black;">Beneficiary ID :
			<input type="hidden" value="" id="callidValue"  /></td>
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
			<input type="hidden" id="beneficiary_ids"  name='beneficiary_ids' value="<?php echo $Beneficiary_Details['registration_id'];?>" /></td>
		</tr><tr><td></td></tr>	
		<tr>
			<td align='right' style="font-family:arial;font-size:15px;color:black;" >First Name :</td>
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
			<input type="text" id='beneficiary_name' name='beneficiary_name' onkeypress="return allowValidKey(event,'callername');" 
			value="<?php echo $Beneficiary_Details['beneficiary_name'];?>"  /></td>
		</tr><tr><td></td></tr>	
		<tr>
					
			<td align='right' style="font-family:arial;font-size:15px;color:black;" >Middle Name  :</td>
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
			<input type="text" id='beneficiary_surname' name='beneficiary_surname' onkeypress="return allowValidKey(event,'callername');" value="<?php echo $Beneficiary_Details['benificiery_surname'];?>"  /></td>
		</tr><tr><td></td></tr>	
		...
		<tr>
			...
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
				<input type="text" id='beneficiary_lname' name='beneficiary_lname' onkeypress="return allowValidKey(event,'callername');" value="<?php echo $Beneficiary_Details['beneficiary_last'];?>"  /></td>
		</tr><tr><td></td></tr>	
		...
		<tr>
			...
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
				...
				onkeypress="return allowValidKey(event,'number');" value="<?php echo $Beneficiary_Details['dob'];?>"  />
		...
		<tr id="dbhtml">
			...
			<td align='nowrap' tyle="font-family:arial;font-size:15px;color:black;">
				...
				onkeyup="AgeLimit(this.value,this.id);"  onkeypress="return allowValidKey(event,'number');" value="<?php echo $Beneficiary_Details['age'];?>" 
				/><span id="age_span" style='color:red;font-size:10px'></span></td>
		</tr><tr><td></td></tr>	
		<tr>
		...
		<tr>
			...
			onkeypress="return allowValidKey(event,'number');" value="<?php echo $Beneficiary_Details['aadhar_uid_no'];?>" onblur="validcheckaadhar12();" /></td>
		</tr>	
		</tr><tr><td></td></tr>
		<tr>
		...
		<tr><tr><td></td></tr>
			...
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
			<input type="text" id='address' name='address' value="<?php echo $Beneficiary_Details['address'];?>"   /></td>
		</tr><tr><td></td></tr>	
		<tr><tr><td></td></tr>
			<td align='right' style="font-family:arial;font-size:15px;color:black;" >Alternative No  : </td>
			<td align='nowrap' style="font-family:arial;font-size:15px;color:black;">
			<input type="text" id='ano' name='ano' maxlength='10'  onblur="return validcheckaadhar123();" onkeypress="return allowValidKey(event,'number');" 
			value="<?php echo $Beneficiary_Details['aPhoneno'];?>" /></td>
		</tr><tr><td></td></tr>	
		<tr><tr><td></td></tr>
